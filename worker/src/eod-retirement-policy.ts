...
export const EOD_RETIREMENT_REQUIRED_SESSIONS = 3;
export const EOD_RETIREMENT_POLICY_VERSION = "three-trading-sessions-v1";
 ...
 * to exist: an absent finalizable trading bucket still blocks retirement. */
