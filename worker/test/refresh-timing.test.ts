...
describe("refresh timing", () => {
  ...
  it("opens after the configured local refresh time so missed slots can catch up", () => {
    ...
    expect(shouldRunScheduledEod(afterWindow, "Australia/Melbourne", "08:15")).toBe(true);
  });
