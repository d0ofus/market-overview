INSERT OR IGNORE INTO research_lab_profiles (
  ...
  'research-lab-freshness-v1',
  'Research Lab Freshness Experimental',
  'Experimental research-lab profile for freshness-sensitive news and earnings synthesis with prior-memory comparison context.',
  1,
  0,
  'research-lab-profile-freshness-v1-version-1'
);
...
INSERT OR IGNORE INTO research_lab_profile_versions (
  ...
  COALESCE(
    (
      ...
      WHERE id = 'research-lab-profile-default-v1'
      LIMIT 1
    ),
    'claude-sonnet-4-6'
  ),
...
SET current_version_id = 'research-lab-profile-freshness-v1-version-1',
    updated_at = CURRENT_TIMESTAMP
WHERE id = 'research-lab-profile-freshness-v1'
  AND (current_version_id IS NULL OR current_version_id = '' OR current_version_id = 'research-lab-profile-freshness-v1-version-1');
