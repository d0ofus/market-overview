...
- End section 17 with: "Bottom line: [one clear sentence summarizing the current market regime and trading posture]."',
  ...
  '["US stock market today S&P 500 Nasdaq Dow Russell sector performance {latestCompletedSessionDate} Reuters CNBC MarketWatch","US economic calendar Fed speakers Treasury auctions CPI PPI PCE GDP jobs ISM {latestCompletedSessionDate}","CBOE VIX put call ratio market volatility today {latestCompletedSessionDate}","US stocks earnings catalysts mega cap tech semiconductors banks energy today {latestCompletedSessionDate}"]',
  1,
  'Australia/Melbourne',
  '09:00',
