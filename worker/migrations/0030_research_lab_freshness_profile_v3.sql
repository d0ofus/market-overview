INSERT OR IGNORE INTO research_lab_profile_versions (
  ...
  'research-lab-profile-freshness-v1-version-3',
  ...
  COALESCE(
    (
      ...
      WHERE id = 'research-lab-profile-freshness-v1-version-2'
      LIMIT 1
    ),
    'claude-sonnet-4-6'
  ),
...
SET current_version_id = 'research-lab-profile-freshness-v1-version-3',
