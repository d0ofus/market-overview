...
import {
  MultiChartMetricBubble as MetricBubble,
  MultiChartMovementExpansion as MovementExpansion,
  MultiChartNewsList as NewsList,
                      ...
                      <div className="mt-4 flex flex-wrap justify-between gap-2">
                        <div className="flex flex-wrap gap-2">
                          ...
                          <button
                            ...
                            onClick={() => toggleMovement(compoundKey, row.ticker)}
                          >
