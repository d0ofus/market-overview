...
export function AdminBuilder() {
  ...
  const [schedulePageTarget, setSchedulePageTarget] = useState<"overview" | "breadth" | "sectors" | "thirteenf" | "admin" | "scans" | "watchlist-compiler" | "gappers">("overview");
      ...
      <div className="card p-3">
        ...
        <div className="mt-2 grid gap-2 md:grid-cols-5">
          ...
          <select
            ...
            onChange={(e) => setSchedulePageTarget(e.target.value as "overview" | "breadth" | "sectors" | "thirteenf" | "admin" | "scans" | "watchlist-compiler" | "gappers")}
          >
